...
class YouTubeTranscriptDownloader:
    def __init__(self, languages: List[str] = ["pt-PT","pt", "en"]):
...
if __name__ == "__main__":
    video_id = "https://www.youtube.com/watch?v=sX6xBrSb-TU"  # Extract from URL: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
