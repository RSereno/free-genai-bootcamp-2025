...
LLM_MODEL_ID = os.getenv("LLM_MODEL_ID", "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B")
...
class LangPortalService:
    def __init__(self, host="0.0.0.0", port=8000):
        self.host = host
        self.port = port
        self.endpoint =  "/langportal-service"
    ...
    def add_remote_service(self):
        ...
        self.megaservice.add(vllm).add(embedding)
        self.megaservice.flow_to(embedding, vllm)
...
if __name__ == "__main__":
    ...
    langPortal = LangPortalService(port=MEGA_SERVICE_PORT)

    langPortal.add_remote_service()
